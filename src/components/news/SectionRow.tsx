...
export function SectionRow({ id, title, accent, stories }: { id: string; title: string; accent?: boolean; stories: Story[] }) {
  return (
    <section id={id} className="mx-auto max-w-7xl px-4 py-10 border-t border-border">
      <div className="flex items-end justify-between mb-6">
        ...
        <a href="#" className="text-xs font-bold uppercase tracking-wider text-muted-foreground hover:text-breaking inline-flex items-center gap-1">
        ...
        {stories.map((s, i) => (
          <a key={i} href="#" className="group block">
            <div className="overflow-hidden rounded-md bg-muted aspect-[4/3]">
              <img src={s.img} alt="" width={800} height={600} loading="lazy"
            ...
            <div className="mt-3">
              ...
              {s.excerpt && <p className="mt-1.5 text-sm text-muted-foreground line-clamp-2">{s.excerpt}</p>}
