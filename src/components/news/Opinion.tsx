const ops = [
  {
    author: "Dr. Ranjita Bora",
    role: "Political analyst",
    quote:
      "The Northeast is no longer a footnote in Delhi's policy memos — it is the chapter being written right now.",
  },
  {
    author: "Hiren Gohain",
    role: "Senior columnist",
    quote:
      "If Assam's youth migration is the question, dignified local employment is the only honest answer.",
  },
  {
    author: "Mary Kom",
    role: "Guest column",
    quote:
      "Sport gave the Northeast its first national stage. The next stage must be built by the state, not the athlete.",
  },
];
      ...
      <div className="lg:col-span-2" id="opinion">
        ...
        <div className="grid sm:grid-cols-3 gap-5">
          {ops.map((o) => (
            <article
              key={o.author}
              className="bg-card border border-border rounded-md p-5 hover:border-navy dark:hover:border-foreground transition-colors"
            >
